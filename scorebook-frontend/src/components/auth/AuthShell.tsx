...
/** Shared glass layout for login / sign-up (matches Connect + landing style). */
    ...
    <div className="min-h-screen mesh-bg flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 pt-20 pb-16">
        ...
        >
          ...
          <div className="glass rounded-2xl p-8 border border-white/5 shadow-xl shadow-black/20">
            {children}
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase tracking-widest">
                <span className="px-3 bg-[#0d1117]/90 text-slate-500 font-semibold">Or continue with</span>
              </div>
            </div>
